...
require('lazy').setup({
  ...
  'edkolev/tmuxline.vim',
  {
    ...
    config = function()
      local dashboard_theme = require 'alpha.themes.theta'
      dashboard_theme.header.val = {
        '                                                     ',
        '  ███╗   ██╗███████╗ ██████╗ ██╗   ██╗██╗███╗   ███╗ ',
        '  ████╗  ██║██╔════╝██╔═══██╗██║   ██║██║████╗ ████║ ',
        '  ██╔██╗ ██║█████╗  ██║   ██║██║   ██║██║██╔████╔██║ ',
      ...
      table.insert(dashboard_theme.config.layout, 1, { type = 'padding', val = 10 }) -- add more top padding
      table.remove(dashboard_theme.config.layout, 7) -- remove quick links
      dashboard_theme.file_icons.provider = 'devicons'
      require('alpha').setup(dashboard_theme.config)
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'css', 'javascript', 'c_sharp' },
  ...
  require 'kickstart.plugins.autopairs', -- adds closing pair of {['"
